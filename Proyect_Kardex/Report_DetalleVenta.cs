...
{
    public partial class Report_DetalleVenta : Form
    {
        ...
        private void Report_DetalleVenta_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM Detalle_Venta WHERE cod_Venta = '"+coddet+"'; ", fu.GetCONN());
